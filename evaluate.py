...
from pytorch_stardist.data.utils import load_img, get_files
...
def evaluate(Y_pred, Y, use_tqdm=True):
    """
    ...
    if use_tqdm:
        ...
        stats = [matching_dataset(Y, Y_pred, thresh=t, show_progress=False) for t in taus]
